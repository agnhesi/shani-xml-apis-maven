...
public interface HTMLDocument
     ...
     * with <code>BODY</code> contents, returns the <code>BODY</code> element.
     ...
     * to include images, authors may use the <code>OBJECT</code> element or
     * the <code>IMG</code> element. Therefore, it is recommended not to use
     ...
     * with the <code>id</code> attribute. Note that in [ <a
     * href='http://www.w3.org/TR/2002/REC-xhtml1-20020801'>XHTML 1.0 </a>],
     * the <code>name</code> attribute (see section 4.10) has no semantics and
     ...
     * non-terminal of [ <a href='http://www.ietf.org/rfc/rfc2965.txt'>IETF
     * RFC 2965 </a>], Section 4.2.2. <br>
     * If no persistent state information is available for the current frame
     * or document document, then this property's value is an empty string. <br>
     ...
     * name-value pairs, each list item being separated by a ';' (semicolon). <br>
     ...
     * href='http://www.ietf.org/rfc/rfc2965.txt'>IETF RFC 2965 </a>]; that
     ...
     * absolute URI [ <a href='http://www.ietf.org/rfc/rfc2396.txt'>IETF RFC
     * 2396 </a>] of the current frame or document. If no path attribute is
     * specified, then the path attribute for the new value defaults to the
     * absolute path portion of the URI [ <a
     ...
     * storage. See [ <a href='http://www.ietf.org/rfc/rfc2965.txt'>IETF RFC
     * 2965 </a>] for the semantics of persistent state item attribute value
     ...
     *            the cookie syntax specified by [ <a
     *            href='http://www.ietf.org/rfc/rfc2965.txt'>IETF RFC 2965
     *            </a>].
     */
