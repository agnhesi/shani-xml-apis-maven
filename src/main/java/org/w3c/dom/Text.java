...
/**
 * The <code>Text</code> interface inherits from <code>CharacterData</code> and
 * represents the textual content (termed <a
 * href='http://www.w3.org/TR/2004/REC-xml-20040204#syntax'>character data
 * </a> in XML) of an <code>Element</code> or <code>Attr</code>. If there is
 * no markup inside an element's content, the text is contained in a single
 * object implementing the <code>Text</code> interface that is the only child
 ...
 * 
 * <p>
 * No lexical check is done on the content of a <code>Text</code> node and,
...
public interface Text
     ...
     *            is negative or greater than the number of 16-bit units in <code>data</code>.<br>
     ...
     * raising a <code>DOMException</code> with the code <code>NO_MODIFICATION_ALLOWED_ERR</code>.<br>
     ...
     *            the <code>Text</code> nodes being replaced is readonly.
     *
     * @since DOM Level 3
     */
