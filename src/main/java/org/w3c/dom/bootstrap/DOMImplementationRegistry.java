...
public final class DOMImplementationRegistry {
    ...
    /**
     * Obtain a new instance of a <code>DOMImplementationRegistry</code>. The
     * <code>DOMImplementationRegistry</code> is initialized by the
     * application or the implementation, depending on the context, by first
     * checking the value of the Java system property
     * <code>org.w3c.dom.DOMImplementationSourceList</code> and the the
     * service provider whose contents are at "
     * <code>META_INF/services/org.w3c.dom.DOMImplementationSourceList</code>"
     * The value of this property is a white-space separated list of names of
     * availables classes implementing the
     * <code>DOMImplementationSource</code> interface. Each class listed in
     * the class name list is instantiated and any exceptions encountered are
     ...
     *        specified by its name optionally followed by a space and a
     *        version number. This is something like: "XML 1.0 Traversal
     *        +Events 2.0"
     *
        ...
        return new DOMImplementationList() {
                public DOMImplementation item(final int index) {
                    if ((index >= 0) && (index < implementations.size())) {
                        try {
                            return (DOMImplementation) implementations
                            .elementAt(index);
     ...
     * META_INF/services/org.w3c.dom.DOMImplementationSourceList from the
     ...
     * META_INF/services/org.w3c.dom.DOMImplementationSourceList after
     * checking access control privileges. For a JRE 1.1, this check is not
     * done.
     *
