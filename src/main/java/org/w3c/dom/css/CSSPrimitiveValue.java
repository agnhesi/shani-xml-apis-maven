...
public interface CSSPrimitiveValue
     ...
     * by using the <code>cssText</code> attribute.
     */
     ...
     * be raised.
     *
     * @param unitType A unit code as defined above. The unit code can only be
     ...
     *
     * @exception DOMException INVALID_ACCESS_ERR: Raised if the attached
     *            property doesn't support the float value or the unit type. <br>
     ...
     *
     * @exception DOMException INVALID_ACCESS_ERR: Raised if the CSS value
     ...
     *
     * @exception DOMException INVALID_ACCESS_ERR: Raised if the CSS value
     *            doesn't contain a string value or if the string value can't
     *            be converted into the specified unit. <br>
     *            NO_MODIFICATION_ALLOWED_ERR: Raised if this property is
     *            readonly.
     */
     ...
     *
     * @exception DOMException INVALID_ACCESS_ERR: Raised if the CSS value
     *            doesn't contain a Counter value (e.g. this is not
     ...
     *
     * @exception DOMException INVALID_ACCESS_ERR: Raised if the attached
     *            property can't return a RGB color value (e.g. this is not
