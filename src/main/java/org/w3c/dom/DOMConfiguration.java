...
/**
 * The <code>DOMConfiguration</code> interface represents the configuration of
 ...
 * <code>CDATASection</code> nodes with <code>Text</code> nodes or specifying
 * the type of the schema that must be used when the validation of the
 * <code>Document</code> is requested. <code>DOMConfiguration</code> objects
 * are also used in [ <a
 * href='http://www.w3.org/TR/2004/REC-DOM-Level-3-LS-20040407'>DOM Level 3
 * Load and Save </a>] in the <code>DOMParser</code> and
 * <code>DOMSerializer</code> interfaces.
 * 
 * <p>
 * The parameter names used by the <code>DOMConfiguration</code> object are
 ...
 * not. <b>Note: </b> Parameters are similar to features and properties used
 * in SAX2 [ <a href='http://www.saxproject.org/'>SAX </a>].
 * </p>
 * 
 * <p>
 ...
 * </dt>
 * <dd>
 * [<em>optional</em>] Canonicalize the document according to the rules
 * specified in [ <a
 * href='http://www.w3.org/TR/2001/REC-xml-c14n-20010315'>Canonical XML </a>],
 * such as removing the <code>DocumentType</code> node (if any) from the tree,
 ...
 * Setting this parameter to <code>true</code> will also set the state of the
 * parameters listed below. Later changes to the state of one of those
 * parameters will revert "canonical-form" back to <code>false</code>.
 * Parameters set to <code>false</code>: "entities", " normalize-characters",
 ...
 * </dt>
 * <dd>
 * [<em>required</em>] (<em>default</em> )Do not canonicalize the document.
 * </dd>
 * </dl>
 * 
 * </dd>
 ...
 * </dt>
 * <dd>
 * [<em>required</em>] (<em>default</em> )Keep <code>CDATASection</code> nodes
 * in the document.
 * </dd>
 * <dt>
 * <code>false</code>
 * </dt>
 * <dd>
 * [<em>required</em> ]Transform <code>CDATASection</code> nodes in the
 * document into <code>Text</code> nodes. The new <code>Text</code> node is
 * then combined with any adjacent <code>Text</code> node.
 * </dd>
 * </dl>
 * 
 * </dd>
 ...
 * </dt>
 * <dd>
 * [<em>optional</em>] Check if the characters in the document are <a
 * href='http://www.w3.org/TR/2004/REC-xml11-20040204/#dt-fullnorm'>fully
 * normalized </a>, as defined in appendix B of [ <a
 * href='http://www.w3.org/TR/2004/REC-xml11-20040204/'>XML 1.1 </a>]. When a
 ...
 * </dt>
 * <dd>
 * [<em>required</em>] (<em>default</em> )Do not check if characters are
 * normalized.
 * </dd>
 * </dl>
 * 
 ...
 * </dt>
 * <dd>
 * [<em>required</em>] (<em>default</em> )Keep <code>Comment</code> nodes in
 * the document.
 * </dd>
 * <dt>
 * <code>false</code>
 * </dt>
 * <dd>
 * [<em>required</em> ]Discard <code>Comment</code> nodes in the document.
 * </dd>
 * </dl>
 * 
 * </dd>
 ...
 * </dt>
 * <dd>
 * [<em>optional</em>] Expose schema normalized values in the tree, such as <a
 * href='http://www.w3.org/TR/2001/REC-xmlschema-1-20010502/#key-nv'>XML
 * Schema normalized values </a> in the case of XML Schema. Since this
 * parameter requires to have schema information, the "validate" parameter
 * will also be set to <code>true</code>. Having this parameter activated when
 * "validate" is <code>false</code> has no effect and no schema-normalization
 * will happen. <b>Note: </b> Since the document contains the result of the
 * XML 1.0 processing, this parameter does not apply to attribute value
 * normalization as defined in section 3.3.3 of [ <a
 * href='http://www.w3.org/TR/2004/REC-xml-20040204'>XML 1.0 </a>] and is only
 ...
 * </dt>
 * <dd>
 * [<em>required</em>] (<em>default</em>) Do not perform schema normalization
 * on the tree.
 * </dd>
 * </dl>
 * 
 ...
 * </dt>
 * <dd>
 * [<em>required</em>] (<em>default</em> )Keep all whitespaces in the document.
 * </dd>
 * <dt>
 * <code>false</code>
 * </dt>
 * <dd>
 * [<em>optional</em>] Discard all <code>Text</code> nodes that contain
 * whitespaces in element content, as described in <a
 * href='http://www.w3.org/TR/2004/REC-xml-infoset-20040204#infoitem.character'>
 * [element content whitespace] </a>. The implementation is expected to use
 * the attribute <code>Text.isElementContentWhitespace</code> to determine if
 * a <code>Text</code> node should be discarded or not.
 * </dd>
 * </dl>
 * 
 * </dd>
 ...
 * </dt>
 * <dd>
 * [<em>required</em>] (<em>default</em> )Keep <code>EntityReference</code>
 ...
 * </dt>
 * <dd>
 * [<em>required</em>] Remove all <code>EntityReference</code> nodes from the
 * document, putting the entity expansions directly in their place.
 * <code>Text</code> nodes are normalized, as defined in
 * <code>Node.normalize</code>. Only <a
 * href='http://www.w3.org/TR/2004/REC-xml-infoset-20040204/#infoitem.rse'>
 * unexpanded entity references </a> are kept in the document.
 * </dd>
 * </dl>
 * 
 * <b>Note: </b> This parameter does not affect <code>Entity</code> nodes.
 * </dd>
 * <dt>
 * <code>"error-handler"</code>
 * </dt>
 * <dd>
 * [<em>required</em>] Contains a <code>DOMErrorHandler</code> object. If an
 ...
 * </dt>
 * <dd>
 * [<em>required</em> ]Keep in the document the information defined in the XML
 * Information Set [ <a
 * href='http://www.w3.org/TR/2004/REC-xml-infoset-20040204/'>XML Information
 * Set </a>] .This forces the following parameters to <code>false</code>: "
 ...
 * parameter with <code>getParameter</code> returns <code>true</code> only if
 ...
 * </dt>
 * <dd>
 * Setting <code>infoset</code> to <code>false</code> has no effect.
 * </dd>
 * </dl>
 * 
 * </dd>
 ...
 * </dt>
 * <dd>
 * [<em>required</em>] (<em>default</em>) Perform the namespace processing as
 * defined in .
 * </dd>
 * <dt>
 * <code>false</code>
 ...
 * </dt>
 * <dd>
 * [<em>required</em>] (<em>default</em>) Include namespace declaration
 * attributes, specified or defaulted from the schema, in the document. See
 * also the sections "Declaring Namespaces" in [ <a
 * href='http://www.w3.org/TR/1999/REC-xml-names-19990114/'>XML Namespaces
 * </a>] and [ <a
 ...
 * </dt>
 * <dd>
 * [<em>required</em> ]Discard all namespace declaration attributes. The
 * namespace prefixes (<code>Node.prefix</code>) are retained even if this
 ...
 * [<em>optional</em>] <a
 * href='http://www.w3.org/TR/2004/REC-xml11-20040204/#dt-fullnorm'>Fully
 * normalized </a> the characters in the document as defined in appendix B of
 ...
 * </dt>
 * <dd>
 * [<em>required</em>] (<em>default</em> )Do not perform character
 * normalization.
 * </dd>
 * </dl>
 * 
 ...
 * </dt>
 * <dd>
 * [<em>optional</em>] Represent a <code>DOMString</code> object containing a
 * list of URIs, separated by whitespaces (characters matching the <a
 * href='http://www.w3.org/TR/2004/REC-xml-20040204#NT-S'>nonterminal
 * production S </a> defined in section 2.3 [ <a
 * href='http://www.w3.org/TR/2004/REC-xml-20040204'>XML 1.0 </a>]), that
 ...
 * type specified with <code>schema-type</code>, otherwise the behavior of an
 ...
 * <code>schemaLocation</code> attribute) in a schema document (i.e. using
 * schema <code>import</code> mechanisms) share the same
 ...
 * the same <code>targetNamespace</code> or have no namespace, the behavior is
 * implementation dependent. If no location has been provided, this parameter
 * is <code>null</code>. <b>Note: </b> The <code>"schema-location"</code>
 * parameter is ignored unless the "schema-type" parameter value is set. It is
 * strongly recommended that <code>Document.documentURI</code> will be set so
 ...
 * </dt>
 * <dd>
 * [<em>optional</em>] Represent a <code>DOMString</code> object containing an
 ...
 * is <code>null</code>. <b>Note: </b> For XML Schema [ <a
 * href='http://www.w3.org/TR/2001/REC-xmlschema-1-20010502/'>XML Schema Part
 * 1 </a>] , applications must use the value
 ...
 * </dt>
 * <dd>
 * [<em>required</em>] (<em>default</em> )Split CDATA sections containing the
 * CDATA section termination marker ']]&gt;'. When a CDATA section is split a
 * warning is issued with a <code>DOMError.type</code> equals to
 ...
 * </dt>
 * <dd>
 * [<em>required</em> ]Signal an error if a <code>CDATASection</code> contains
 ...
 * </dt>
 * <dd>
 * [<em>optional</em>] Require the validation against a schema (i.e. XML
 * schema, DTD, any other type or representation of schema) of the document as
 * it is being normalized as defined by [ <a
 * href='http://www.w3.org/TR/2004/REC-xml-20040204'>XML 1.0 </a>]. If
 ...
 * <ul>
 * <li>
 * Attribute nodes with <code>Attr.specified</code> equals to
 * <code>false</code>, as specified in the description of the
 * <code>Attr</code> interface;
 * </li>
 * <li>
 * The value of the attribute <code>Text.isElementContentWhitespace</code> for
 * all <code>Text</code> nodes;
 * </li>
 * <li>
 * The value of the attribute <code>Attr.isId</code> for all <code>Attr</code>
 * nodes;
 * </li>
 * <li>
 * The attributes <code>Element.schemaTypeInfo</code> and
 * <code>Attr.schemaTypeInfo</code>.
 * </li>
 * </ul>
 * 
 * <b>Note: </b> "validate-if-schema" and "validate" are mutually exclusive,
 * setting one of them to <code>true</code> will set the other one to
 * <code>false</code>. Applications should also consider setting the parameter
 * "well-formed" to <code>true</code>, which is the default for that option,
 ...
 * </dt>
 * <dd>
 * [<em>required</em>] (<em>default</em>) Do not accomplish schema processing,
 ...
 * "validate-if-schema" is <code>true</code>.
 * </dd>
 * </dl>
 * 
 * </dd>
 ...
 * </dt>
 * <dd>
 * [<em>optional</em> ]Enable validation only if a declaration for the document
 ...
 * parameter "validate" set to <code>true</code>. <b>Note: </b>
 * "validate-if-schema" and "validate" are mutually exclusive, setting one of
 * them to <code>true</code> will set the other one to <code>false</code>.
 * </dd>
 * <dt>
 * <code>false</code>
 * </dt>
 * <dd>
 * [<em>required</em>] (<em>default</em>) No schema processing should be
 ...
 * validation must still happen if "validate " is <code>true</code>.
 * </dd>
 * </dl>
 * 
 * </dd>
 ...
 * </dt>
 * <dd>
 * [<em>required</em>] (<em>default</em>) Check if all nodes are XML well
 * formed according to the XML version in use in
 * <code>Document.xmlVersion</code>:
 * 
 * <ul>
 * <li>
 * check if the attribute <code>Node.nodeName</code> contains invalid
 * characters according to its node type and generate a <code>DOMError</code>
 * of type <code>"wf-invalid-character-in-node-name"</code>, with a
 * <code>DOMError.SEVERITY_ERROR</code> severity, if necessary;
 * </li>
 * <li>
 * check if the text content inside <code>Attr</code>,
 * <code>Element</code>,<code>Comment</code>,<code>Text</code>,
 * <code>CDATASection</code> nodes for invalid characters and generate a
 * <code>DOMError</code> of type <code>"wf-invalid-character"</code>, with a
 * <code>DOMError.SEVERITY_ERROR</code> severity, if necessary;
 * </li>
 * <li>
 * check if the data inside <code>ProcessingInstruction</code> nodes for
 * invalid characters and generate a <code>DOMError</code> of type
 ...
 * using <code>Document.documentURI</code>. However, when the feature "LS"
 * defined in [ <a
 * href='http://www.w3.org/TR/2004/REC-DOM-Level-3-LS-20040407'>DOM Level 3
 * Load and Save </a>] is supported by the DOM implementation, the parameter
 * "resource-resolver" can also be used on <code>DOMConfiguration</code>
 * objects attached to <code>Document</code> nodes. If this parameter is set,
 * <code>Document.normalizeDocument()</code> will invoke the resource resolver
 * instead of using <code>Document.documentURI</code>.
 * </p>
 * 
 * <p>
 * See also the <a
...
public interface DOMConfiguration {
     ...
     *            recognized but the requested value cannot be set. <br>
     ...
     *        <code>true</code>.
     *
     * @return <code>true</code> if the parameter could be successfully set to
     *         the specified value, or <code>false</code> if the parameter is
