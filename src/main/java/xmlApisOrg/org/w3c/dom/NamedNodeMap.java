...
public interface NamedNodeMap {
     ...
     * As the <code>nodeName</code> attribute is used to derive the name which
     * the node must be stored under, multiple nodes of certain types (those
     * that have a "special" string value) cannot be stored as the names would
     ...
     *
     * @exception DOMException WRONG_DOCUMENT_ERR: Raised if <code>arg</code>
     ...
     * value as well as the corresponding namespace URI, local name, and
     ...
     *         exists.
     *
     * @exception DOMException NOT_FOUND_ERR: Raised if there is no node named
     ...
     * Namespaces </a>] , applications must use the value null as the
     ...
     *
     * @exception DOMException NOT_FOUND_ERR: Raised if there is no node with
     *            the specified <code>namespaceURI</code> and
