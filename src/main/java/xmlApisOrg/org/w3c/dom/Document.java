...
public interface Document
     ...
     * declaration this returns <code>null</code>. For HTML documents, a
     * <code>DocumentType</code> object may be returned, independently of the
     * presence or absence of document type declaration in the HTML document. <br>
     * This provides direct access to the <code>DocumentType</code> node,
     ...
     * "Core", such as "HTML" [ <a
     * href='http://www.w3.org/TR/2003/REC-DOM-Level-2-HTML-20030109'>DOM
     * Level 2 HTML </a>] , based on the <code>DocumentType</code> specified
     ...
     *        should invoke <code>Document.normalizeDocument()</code> with the
     *        parameter " namespaces" set to <code>true</code> in order to
     ...
     * corresponding <code>Entity</code> node. <b>Note: </b> If any descendant
     * of the <code>Entity</code> node has an unbound namespace prefix, the
     * corresponding descendant of the created <code>EntityReference</code>
     * node is also unbound; (its <code>namespaceURI</code> is
     * <code>null</code>). The DOM Level 2 and 3 do not support any mechanism
     ...
     * @exception DOMException INVALID_CHARACTER_ERR: Raised if the specified
     *            name is not an XML name according to the XML version in use
     *            specified in the <code>Document.xmlVersion</code> attribute. <br>
     *            NOT_SUPPORTED_ERR: Raised if this document is an HTML
     *            document.
     */
     ...
     * ( <code>parentNode</code> is <code>null</code>).<br>
     * For all nodes, importing a node creates a node object owned by the
     * importing document, with attribute values identical to the source
     * node's <code>nodeName</code> and <code>nodeType</code>, plus the
     * attributes related to namespaces
     * (<code>prefix</code>,<code>localName</code>, and
     * <code>namespaceURI</code>). As in the <code>cloneNode</code> operation,
     * the source node is not altered. User data associated to the imported
     * node is not carried over. However, if any <code>UserDataHandlers</code>
     ...
     * </dt>
     * <dd>
     * The <code>ownerElement</code> attribute is set to <code>null</code> and
     * the <code>specified</code> flag is set to <code>true</code> on the
     * generated <code>Attr</code>. The descendants of the source
     * <code>Attr</code> are recursively imported and the resulting nodes
     * reassembled to form the corresponding subtree. Note that the
     * <code>deep</code> parameter has no effect on <code>Attr</code> nodes;
     ...
     * </dt>
     * <dd>
     * If the <code>deep</code> option was set to <code>true</code>, the
     * descendants of the source <code>DocumentFragment</code> are recursively
     ...
     * </dt>
     * <dd>
     * <code>Document</code> nodes cannot be imported.
     * </dd>
     * <dt>
     * DOCUMENT_TYPE_NODE
     * </dt>
     * <dd>
     * <code>DocumentType</code> nodes cannot be imported.
     * </dd>
     * <dt>
     * ELEMENT_NODE
     * </dt>
     * <dd>
     * <em>Specified</em> attribute nodes of the source element are imported,
     * and the generated <code>Attr</code> nodes are attached to the generated
     * <code>Element</code>. Default attributes are <em>not</em> copied,
     ...
     * <code>Entity</code> are recursively imported and the resulting nodes
     ...
     * <code>deep</code> import is requested, since the source and destination
     ...
     * Note that the <code>deep</code> parameter has no effect on this type of
     ...
     * values from those of the source node.Note that the <code>deep</code>
     ...
     * </dt>
     * <dd>
     * These three types of nodes inheriting from <code>CharacterData</code>
     * copy their <code>data</code> and <code>length</code> attributes from
     * those of the source node.Note that the <code>deep</code> parameter has
     ...
     *            href='http://www.w3.org/TR/2004/REC-xml11-20040204/'>XML 1.1
     *            </a>] element into an XML 1.0 document, for instance.
     *
     * @since DOM Level 2
     */
     ...
     *
     * @exception DOMException INVALID_CHARACTER_ERR: Raised if the specified
     *            <code>qualifiedName</code> is not an XML name according to
     ...
     *            malformed qualified name, if the <code>qualifiedName</code>
     *            has a prefix and the <code>namespaceURI</code> is
     *            <code>null</code>, or if the <code>qualifiedName</code> has
     *            a prefix that is "xml" and the <code>namespaceURI</code> is
     *            different from " <a
     *            href='http://www.w3.org/XML/1998/namespace'>http://www.w3.org/XML/1998/namespace
     *            </a>" [ <a
     *            href='http://www.w3.org/TR/1999/REC-xml-names-19990114/'>XML
     *            Namespaces </a>] , or if the <code>qualifiedName</code> or
     *            its prefix is "xmlns" and the <code>namespaceURI</code> is
     *            different from " <a
     *            href='http://www.w3.org/2000/xmlns/'>http://www.w3.org/2000/xmlns/
     *            </a>", or if the <code>namespaceURI</code> is " <a
     *            href='http://www.w3.org/2000/xmlns/'>http://www.w3.org/2000/xmlns/
     *            </a>" and neither the <code>qualifiedName</code> nor its
     *            prefix is "xmlns". <br>
     *            NOT_SUPPORTED_ERR: Always thrown if the current document
     *            does not support the <code>"XML"</code> feature, since
     ...
     * Per [ <a href='http://www.w3.org/TR/1999/REC-xml-names-19990114/'>XML
     * Namespaces </a>] , applications must use the value <code>null</code> as
     * the <code>namespaceURI</code> parameter for methods if they wish to
     * have no namespace.
     *
     ...
     *            malformed qualified name, if the <code>qualifiedName</code>
     *            has a prefix and the <code>namespaceURI</code> is
     *            <code>null</code>, if the <code>qualifiedName</code> has a
     *            prefix that is "xml" and the <code>namespaceURI</code> is
     *            different from " <a
     *            href='http://www.w3.org/XML/1998/namespace'>http://www.w3.org/XML/1998/namespace
     *            </a>", if the <code>qualifiedName</code> or its prefix is
     *            "xmlns" and the <code>namespaceURI</code> is different from
     *            " <a
     *            href='http://www.w3.org/2000/xmlns/'>http://www.w3.org/2000/xmlns/
     *            </a>", or if the <code>namespaceURI</code> is " <a
     *            href='http://www.w3.org/2000/xmlns/'>http://www.w3.org/2000/xmlns/
     ...
     * href='http://www.w3.org/TR/2004/REC-xml-20040204#NT-XMLDecl'>XML
     * declaration </a>, the encoding of this document. This is
     ...
     * An attribute specifying, as part of the <a
     * href='http://www.w3.org/TR/2004/REC-xml-20040204#NT-XMLDecl'>XML
     * declaration </a>, whether this document is standalone. This is
     * <code>false</code> when unspecified. <b>Note: </b> No verification is
     ...
     * constraint for standalone document declaration </a> as defined in [ <a
     ...
     * An attribute specifying, as part of the <a
     * href='http://www.w3.org/TR/2004/REC-xml-20040204#NT-XMLDecl'>XML
     * declaration </a>, the version number of this document. If there is no
     * declaration and if this document supports the "XML" feature, the value
     * is <code>"1.0"</code>. If this document does not support the "XML"
     * feature, the value is always <code>null</code>. Changing this attribute
     * will affect methods that check for invalid characters in XML names.
     * Application should invoke <code>Document.normalizeDocument()</code> in
     * order to check for invalid characters in the <code>Node</code> s that
     * are already part of this <code>Document</code>.<br>
     * DOM applications may use the
     * <code>DOMImplementation.hasFeature(feature, version)</code> method with
     * parameter values "XMLVersion" and "1.0" (respectively) to determine if
     * an implementation supports [ <a
     ...
     * <code>Document</code> objects supporting a version of the "XMLVersion"
     * feature must not raise a <code>NOT_SUPPORTED_ERR</code> exception for
     * the same version number when using <code>Document.xmlVersion</code>.
     *
     * @return DOCUMENT ME!
     *
     * @since DOM Level 3
     ...
     *            <code>Document</code> or if this document does not support
     *            the "XML" feature.
     *
     * @since DOM Level 3
     */
     ...
     * set to <code>false</code>, the implementation is free to not test every
     * possible error case normally defined on DOM operations, and not raise
     * any <code>DOMException</code> on DOM operations or report errors while
     * using <code>Document.normalizeDocument()</code>. In case of error, the
     * behavior is undefined. This attribute is <code>true</code> by default.
     *
     * @return DOCUMENT ME!
     *
     * @since DOM Level 3
    ...
    /**
     * The location of the document or <code>null</code> if undefined or if the
     * <code>Document</code> was created using
     * <code>DOMImplementation.createDocument</code>. No lexical checking is
     * performed when setting this attribute; this could result in a
     * <code>null</code> value returned when using <code>Node.baseURI</code>. <br>
     * Beware that when the <code>Document</code> supports the feature "HTML"
     * [ <a href='http://www.w3.org/TR/2003/REC-DOM-Level-2-HTML-20030109'>DOM
     * Level 2 HTML </a>] , the href attribute of the HTML BASE element takes
     ...
     * one document to another (unlike <code>importNode()</code> which create
     * a copy of the source node instead of moving it). When it fails,
     * applications should use <code>Document.importNode()</code> instead.
     ...
     * <code>Attr</code> are recursively adopted.
     * </dd>
     * <dt>
     * DOCUMENT_FRAGMENT_NODE
     * </dt>
     ...
     * </dt>
     * <dd>
     * <code>Document</code> nodes cannot be adopted.
     * </dd>
     * <dt>
     * DOCUMENT_TYPE_NODE
     * </dt>
     * <dd>
     * <code>DocumentType</code> nodes cannot be adopted.
     * </dd>
     * <dt>
     * ELEMENT_NODE
     * </dt>
     * <dd>
     * <em>Specified</em> attribute nodes of the source element are adopted.
     ...
     * </dt>
     * <dd>
     * <code>Entity</code> nodes cannot be adopted.
     * </dd>
     * <dt>
     * ENTITY_REFERENCE_NODE
     * </dt>
     * <dd>
     * Only the <code>EntityReference</code> node itself is adopted, the
     ...
     * </dt>
     * <dd>
     * <code>Notation</code> nodes cannot be adopted.
     * </dd>
     * <dt>
     ...
     * </dl>
     * 
     * <b>Note: </b> Since it does not create new nodes unlike the
     ...
     *            of type <code>DOCUMENT</code>,<code>DOCUMENT_TYPE</code>. <br>
     ...
     * method updates the replacement tree of <code>EntityReference</code>
     * nodes and normalizes <code>Text</code> nodes, as defined in the method <code>Node.normalize()</code>.<br>
     * Otherwise, the actual result depends on the features being set on the
     * <code>Document.domConfig</code> object and governing what operations
     ...
     * <code>CDATASection</code> nodes, etc. See <code>DOMConfiguration</code>
     * for details.
     * <pre>
     * 
     ...
     * changes occurring on the document. <br>
     ...
     * <code>DOMError.SEVERITY_FATAL_ERROR</code>) if an implementation cannot
     ...
     * existing node with the new node as described below. <br>
     ...
     * new node, if the renamed node is an <code>Element</code> its attributes
     ...
     * node. <br>
     * When the node being renamed is an <code>Element</code> only the
     ...
     * guarantee these attributes are up-to-date. <br>
     * When the node being renamed is an <code>Attr</code> that is attached to
     * an <code>Element</code>, the node is first removed from the
     ...
     *            specified node is neither <code>ELEMENT_NODE</code> nor
     *            <code>ATTRIBUTE_NODE</code>, or if the implementation does
     *            not support the renaming of the document element. <br>
     ...
     *            created from a different document than this document. <br>
     *            NAMESPACE_ERR: Raised if the <code>qualifiedName</code> is a
     *            malformed qualified name, if the <code>qualifiedName</code>
     *            has a prefix and the <code>namespaceURI</code> is
     *            <code>null</code>, or if the <code>qualifiedName</code> has
     ...
     *            </a>" [ <a
     *            href='http://www.w3.org/TR/1999/REC-xml-names-19990114/'>XML
     *            Namespaces </a>] . Also raised, when the node being renamed
     *            is an attribute, if the <code>qualifiedName</code>, or its
     *            prefix, is "xmlns" and the <code>namespaceURI</code> is
     *            different from " <a
     *            href='http://www.w3.org/2000/xmlns/'>http://www.w3.org/2000/xmlns/
     *            </a>".
     *
