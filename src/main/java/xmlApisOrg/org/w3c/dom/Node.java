 ...
 * 
 * <p>
 * The values of <code>nodeName</code>,<code>nodeValue</code>, and
...
public interface Node {
     ...
     * node is a <code>Document</code> or a <code>DocumentType</code> which is
     * not used with any <code>Document</code> yet, this is <code>null</code>.
     *
     * @return DOCUMENT ME!
     */
     ...
     * tree, it is first removed. <b>Note: </b> Inserting a node before itself
     ...
     *            <code>newChild</code> node, or if the node to insert is one
     *            of this node's ancestors or this node itself, or if this
     *            node is of type <code>Document</code> and the DOM
     *            application attempts to insert a second
     *            <code>DocumentType</code> or <code>Element</code> node. <br>
     ...
     *            or if the parent of the node being inserted is readonly. <br>
     *            NOT_FOUND_ERR: Raised if <code>refChild</code> is not a
     *            child of this node. <br>
     *            NOT_SUPPORTED_ERR: if this node is of type
     *            <code>Document</code>, this exception might be raised if the
     ...
     * in the list of children, and returns the <code>oldChild</code> node. <br>
     ...
     * removed. <b>Note: </b> Replacing a node with itself is implementation
     * dependent.
     *
     ...
     * @exception DOMException HIERARCHY_REQUEST_ERR: Raised if this node is of
     *            a type that does not allow children of the type of the
     *            <code>newChild</code> node, or if the node to put in is one
     *            of this node's ancestors or this node itself, or if this
     ...
     *            <code>DocumentType</code> child or the <code>Element</code>
     *            child.
     */
     ...
     * @exception DOMException HIERARCHY_REQUEST_ERR: Raised if this node is of
     *            a type that does not allow children of the type of the
     *            <code>newChild</code> node, or if the node to append is one
     *            of this node's ancestors or this node itself, or if this
     *            node is of type <code>Document</code> and the DOM
     ...
     *            readonly. <br>
     *            NOT_SUPPORTED_ERR: if the <code>newChild</code> node is a
     *            child of the <code>Document</code> node, this exception
     *            might be raised if the DOM implementation doesn't support
     *            the removal of the <code>DocumentType</code> child or
     ...
     * <code>Element</code> since the text is contained in a child
     ...
     * addition, clones of unspecified <code>Attr</code> nodes are specified.
     * And, cloning <code>Document</code>,<code>DocumentType</code>,
     * <code>Entity</code>, and <code>Notation</code> nodes is implementation
     * dependent.
     *
     ...
     * </a>] lookups) that depend on a particular document tree structure are
     * to be used. If the parameter "normalize-characters" of the
     * <code>DOMConfiguration</code> object attached to the
     * <code>Node.ownerDocument</code> is <code>true</code>, this method will
     * also fully normalize the characters of the <code>Text</code> nodes.
     * <b>Note: </b> In cases where the document contains
     ...
     * <code>null</code>. <b>Note: </b> Per the <em>Namespaces in XML</em>
     * Specification [ <a
     * href='http://www.w3.org/TR/1999/REC-xml-names-19990114/'>XML Namespaces
     * </a>] an attribute does not inherit its namespace from the element it
     ...
     * unspecified. When it is defined to be <code>null</code>, setting it has
     * no effect, including if the node is read-only. <br>
     ...
     *            readonly. <br>
     *            NAMESPACE_ERR: Raised if the specified <code>prefix</code>
     ...
     *            </a>", if this node is an attribute and the specified prefix
     *            is "xmlns" and the <code>namespaceURI</code> of this node is
     *            different from " <a
     *            href='http://www.w3.org/2000/xmlns/'>http://www.w3.org/2000/xmlns/
     *            </a>", or if this node is an attribute and the
     *            <code>qualifiedName</code> of this node is "xmlns" [ <a
     ...
     * supports the feature "HTML" [ <a
     * href='http://www.w3.org/TR/2003/REC-DOM-Level-2-HTML-20030109'>DOM
     * Level 2 HTML </a>] , the base URI is computed using first the value of
     * the href attribute of the HTML BASE element if any, and the value of
     * the <code>documentURI</code> attribute from the <code>Document</code>
     * interface otherwise.
     *
     * @return DOCUMENT ME!
     *
     ...
     * descendants. When it is defined to be <code>null</code>, setting it has
     ...
     * replaced by a single <code>Text</code> node containing the string this
     * attribute is set to. <br>
     ...
     * (see the attribute <code>Text.isElementContentWhitespace</code>).
     * Similarly, on setting, no parsing is performed either, the input string
     * is taken as pure textual content. <br>
     ...
     * concatenation of the <code>textContent</code> attribute value of every
     ...
     * When two <code>Node</code> references are references to the same
     ...
     *        <code>null</code>, the method will return the default namespace
     *        URI if any.
     *
     ...
     * </li>
     * <li>
     * The following string attributes are equal: <code>nodeName</code>,
     * <code>localName</code>,<code>namespaceURI</code>,
     * <code>prefix</code>,<code>nodeValue</code>. This is: they are both
     * <code>null</code>, or they have the same length and are character for
     * character identical.
     * </li>
     * <li>
     * The <code>attributes</code><code>NamedNodeMaps</code> are equal. This
     ...
     * </li>
     * <li>
     * The <code>childNodes</code><code>NodeLists</code> are equal. This is:
     * they are both <code>null</code>, or they have the same length and
     ...
     * <ul>
     * <li>
     * The following string attributes are equal: <code>publicId</code>,
     * <code>systemId</code>,<code>internalSubset</code>.
     * </li>
     * <li>
     * The <code>entities</code><code>NamedNodeMaps</code> are equal.
     * </li>
     * <li>
     * The <code>notations</code><code>NamedNodeMaps</code> are equal.
     * </li>
     * </ul>
     * 
     ...
     * registered on the nodes. <b>Note: </b> As a general rule, anything not
     ...
     * objects which do not support the <code>Node</code> interface.
     *
     ...
     *        <code>null</code> to remove any existing association to that
     *        key.
     ...
     * first have been set to this node by calling <code>setUserData</code>
     * with the same key.
     *
