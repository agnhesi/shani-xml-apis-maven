 ...
 * 
 * <p>
 * If the document's schema is an XML DTD [ <a
 * href='http://www.w3.org/TR/2004/REC-xml-20040204'>XML 1.0 </a>], the values
 * are computed as follows:
 * 
 * <ul>
 * <li>
 * If this type is referenced from an <code>Attr</code> node,
 * <code>typeNamespace</code> is <code>"http://www.w3.org/TR/REC-xml"</code>
 * and <code>typeName</code> represents the <b>[attribute type] </b> property
 * in the [ <a href='http://www.w3.org/TR/2004/REC-xml-infoset-20040204/'>XML
 * Information Set </a>] . If there is no declaration for the attribute,
 ...
 * 1 </a>] , the values are computed as follows using the
 * post-schema-validation infoset contributions (also called PSVI
 * contributions):
 * 
 * <ul>
 * <li>
 * If the <b>[validity] </b> property exists AND is <em>"invalid"</em> or
 * <em>"notKnown"</em>: the {target namespace} and {name} properties of the
 * declared type if available, otherwise <code>null</code>. <b>Note: </b> At
 ...
 * <ol>
 * <li>
 * If <b>[member type definition] </b> exists:
 * 
 * <ol>
 * <li>
 ...
 * <ol>
 * <li>
 * If it is false, then expose <b>[member type definition name] </b> and
 * <b>[member type definition namespace] </b> properties;
 * </li>
 * <li>
 * Otherwise, expose the namespace and local name of the corresponding
 * anonymous type name.
 ...
 * <ol>
 * <li>
 * If it is false, then expose <b>[type definition name] </b> and <b>[type
 ...
 * </ul>
 * 
 * <b>Note: </b> Other schema languages are outside the scope of the W3C and
 * therefore should define how to represent their type systems using
 * <code>TypeInfo</code>. See also the <a
...
public interface TypeInfo {
     ...
     * Part 1 </a>] , this constant represents the derivation by <a
     ...
     * the reference type definition, and all the <em>derivation methods</em>
     ...
     * href='http://www.w3.org/TR/2001/REC-xmlschema-1-20010502/'>XML Schema
     * Part 1 </a>] , this constant represents the derivation by <a
     * href='http://www.w3.org/TR/2001/REC-xmlschema-1-20010502/#key-typeExtension'>
     * extension </a>. <br>
     ...
     * definition, and at least one of the <em>derivation methods</em>
     ...
     * If the document's schema is an XML Schema [ <a
     * href='http://www.w3.org/TR/2001/REC-xmlschema-1-20010502/'>XML Schema
     * Part 1 </a>] , this constant represents the <a
     * href='http://www.w3.org/TR/2001/REC-xmlschema-1-20010502/#element-union'>
     ...
     * definition by <code>DERIVATION_RESTRICTION</code>, T1 has
     * {variety}<em>union</em>, and one of the {member type definitions} is
     ...
     * href='http://www.w3.org/TR/2001/REC-xmlschema-1-20010502/'>XML Schema
     * Part 1 </a>] , this constant represents the <a
     * href='http://www.w3.org/TR/2001/REC-xmlschema-1-20010502/#element-list'>list
     * </a>. <br>
     ...
     * <code>DERIVATION_EXTENSION</code>, T2 is derived from the other type
     * definition by <code>DERIVATION_RESTRICTION</code>, T1 has
     * {variety}<em>list</em>, and T2 is the {item type definition}. Note that
     ...
     *         <code>false</code>. If the document's schema is an XML Schema,
     *         the method will <code>true</code> if the reference type
     ...
     *         <code>0</code> (no bit is set to <code>1</code> for the
