 ...
 * 
 * <p>
 * As explained in the <code>DOMString</code> interface, text strings in the
...
public interface CharacterData
     ...
     *            <code>offset</code> is negative or greater than the number
     *            of 16-bit units in <code>data</code>, or if the specified
     ...
     *        <code>offset</code> and <code>count</code> exceeds
     *        <code>length</code>, then all 16-bit units to the end of the
     *        data are replaced; (i.e., the effect is the same as a
     *        <code>remove</code> method call with the same range, followed by
     *        an <code>append</code> method invocation).
