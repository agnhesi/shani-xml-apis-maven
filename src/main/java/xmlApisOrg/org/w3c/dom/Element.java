 ...
 * safely be used as a convenience. <b>Note: </b> In DOM Level 2, the method
...
public interface Element
     ...
     *            <code>newAttr</code> was created from a different document
     *            than the one that created the element. <br>
     *            NO_MODIFICATION_ALLOWED_ERR: Raised if this node is
     *            readonly. <br>
     *            INUSE_ATTRIBUTE_ERR: Raised if <code>newAttr</code> is
     *            already an attribute of another <code>Element</code> object.
     *            The DOM user must explicitly clone <code>Attr</code> nodes
     ...
     *            <code>"XML"</code> and the language exposed through the
     *            Document does not support XML Namespaces (such as [ <a
     *            href='http://www.w3.org/TR/1999/REC-html401-19991224/'>HTML
     *            4.01 </a>]).
     *
     * @since DOM Level 2
     */
     ...
     * to be the prefix part of the <code>qualifiedName</code>, and its value
     * is changed to be the <code>value</code> parameter. This value is a
     ...
     *            not support the feature <code>"XML"</code> and the language
     ...
     * but applications should use <code>Document.normalizeDocument()</code>
     * to guarantee this information is up-to-date. <br>
     ...
     * <code>Document.getElementById</code>, but does not change any schema
     ...
     * <code>isId</code> to undeclare an attribute for being a user-determined
     * ID attribute. <br>
